...
with sync_playwright() as p:
    ...
    page.goto(
        "https://video.arrs.org/vod/published/trusted-b561e0e0154c9c3cbc8da2b9/normalized/master_720p_00004.ts",
        timeout=0,
        wait_until="commit"
    )
