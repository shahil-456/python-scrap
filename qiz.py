...
# def process_quiz(page):
#     # Click Continue Exam
#     question_btn = page.locator(
#         "#MainContent_MainContent_MainContent_ucUserLearningActivityDashboardForLearner_ucSelectedExamStatus_Wrapper_ucSelectedExamStatus_Questions_rptExamSections_rptUserQuestions_0_lnkBtnUserQuestion_0"
#     )
...
#         with open(f"quiz-{number}.html", "w", encoding="utf-8") as f:
#             f.write(html)

#         print(f"Saved quiz-{number}.html")

#         # Find Next Question
#         next_btn = page.locator(
#             "#MainContent_MainContent_MainContent_ucQuestionNavigation_lnkBtnNextQuestion"
#         )
...
def main():
    ...
    url="https://education.asnc.org/Users/LearningActivity/LearningActivityDetail.aspx?LearningActivityID=gpMZ%2bBE4%2brUOBASa85OT8g%3d%3d&OriginatedFromUserLearningActivityID=0BT24RrJF%2fiqxXJcB753rw%3d%3d"
